 ...
 */
const socials = [
  { Icon: SiLeetcode, label: "LeetCode", href: "https://leetcode.com/u/Fulbabu/" },
  { Icon: FaXTwitter, label: "X", href: "https://x.com/FulbabuI" },
  { Icon: FaLinkedinIn, label: "LinkedIn", href: "https://www.linkedin.com/in/fulbabu-islam-96a9ba2ba/" },
  { Icon: FaGithub, label: "GitHub", href: "https://github.com/fulbabu-t" },
];
    ...
    <footer className="relative overflow-hidden bg-black">
      ...
      >
        ...
        <p className="text-xs text-gray-400">
          © {new Date().getFullYear()} Fulbabu Islam. All rights reserved.
        </p>
      </motion.div>
    </footer>
  );
