        ...
        <div className="grid md:grid-cols-1">
          ...
          >
            ...
            <p className="text-gray-300 leading-relaxed text-base sm:text-lg">
             I’m a Software Developer, System Designer, and Web Developer — passionate about building fast, resilient applications and crafting seamless user experiences. With a strong foundation in Java, React, Next.js, TypeScript, Tailwind CSS, and FastAPI, I specialize in turning complex ideas into scalable, high-impact web solutions. I thrive on clean architecture, performance optimization, and creating intuitive interfaces that delight users. Whether it’s developing robust APIs or designing sleek frontends, I’m dedicated to delivering products that make a difference.
            </p>
